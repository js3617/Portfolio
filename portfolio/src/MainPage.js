...
import Dot from "./addfunction/Dot.js";
import './Main.css';
import TopButton from "./addfunction/TopButton.js"
...
const MainPage = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setShowScroll(scrollPosition === 1);
    };
  ...
  useEffect(() => {
    const wheelHandler = (e) => {
      ...
      if (deltaY > 0) {
        ...
        const nextScrollTop = nextPageIndex * pageHeight;
        ...
        const prevPageIndex = Math.round(scrollTop / pageHeight);
        if (prevPageIndex > 0) {
          const prevScrollTop = (prevPageIndex - 1) * pageHeight;
    ...
    <div ref={outerDivRef} className="outer">
      ...
      <div className="inner">
        ...
        <div className="backSky">
          <svg id="stars" className="sky"></svg>
        </div>
        )}
